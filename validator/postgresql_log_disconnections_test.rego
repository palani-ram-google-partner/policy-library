...
import data.test.fixtures.postgresql_log_disconnections.constraints as fixture_constraints

import data.validator.gcp.lib as lib
import data.validator.test_utils as test_utils

import data.test.fixtures.postgresql_log_disconnections.assets.no_settings as fixture_no_settings
import data.test.fixtures.postgresql_log_disconnections.assets.no_violations as fixture_no_violation
import data.test.fixtures.postgresql_log_disconnections.assets.violations as fixture_violation

template_name := "GCPPostgreSQLDisConnectionsConstraintV1"

#1. postgresql with correct key
test_postgresql_log_disconnections_no_violations {
...
test_postgresql_log_disconnections_violations {
	expected_resource_names := {"//cloudsql.googleapis.com/projects/prj-dev-palani-ram/instances/tf-pg-ha-62380f9c"}
...
test_postgresql_log_disconnections_no_settings {
	expected_resource_names := {"//cloudsql.googleapis.com/projects/prj-dev-palani-ram/instances/tf-pg-ha-62380f9c"}
	expected_field_name := "key_in_violation"
	expected_field_values := {"log_disconnections"}

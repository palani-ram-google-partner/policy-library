...
import data.test.fixtures.postgresql_log_disconnections.assets as fixture_instances
...
test_postgresql_log_disconnections_no_instances {
	found_violations := find_violations with data.instances as []
	count(found_violations) = 0
}

test_postgresql_log_disconnections_no_constraints {

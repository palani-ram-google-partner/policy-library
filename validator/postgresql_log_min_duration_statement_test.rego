...
#
package templates.gcp.GCPPostgreSQLMinDurationStatementConstraintV1

import data.test.fixtures.postgresql_log_min_duration_statement.constraints as fixture_constraints

import data.validator.gcp.lib as lib
import data.validator.test_utils as test_utils

import data.test.fixtures.postgresql_log_min_duration_statement.assets.no_settings as fixture_no_settings
import data.test.fixtures.postgresql_log_min_duration_statement.assets.no_violations as fixture_no_violation
import data.test.fixtures.postgresql_log_min_duration_statement.assets.violations as fixture_violation


template_name := "GCPPostgreSQLMinDurationStatementConstraintV1"
...
test_postgresql_log_checkpoints_no_settings {
	...
	expected_field_values := {"log_min_duration_statement"}

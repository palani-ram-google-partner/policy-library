...
import data.test.fixtures.compute_serial_port_enable.assets.compute.instance_no_violation as fixture_compute_instance_no_violation
import data.test.fixtures.compute_serial_port_enable.assets.compute.instance_violation as fixture_compute_instance_violation
import data.test.fixtures.compute_serial_port_enable.assets.compute.no_instances as fixture_compute_no_instance
import data.test.fixtures.compute_serial_port_enable.assets.compute.no_metadata as fixture_compute_instance_no_metadata

# Importing the test constraint
import data.test.fixtures.compute_serial_port_enable.constraints as fixture_constraints

template_name := "GCPComputeSerialPortEnableConstraintV1"

#### Testing for GCE instances

#1. No instances at all
test_serial_port_enable_compute_no_instances {
...
test_serial_port_enable_compute_instance_no_violations {
...
test_serial_port_enable_compute_instance_violations {
	expected_resource_names := {"//compute.googleapis.com/projects/prj-dev-palani-ram/zones/us-central1-f/instances/pals-jumphost"}
...
test_serial_port_enable_compute_instance_no_metadata {
	expected_resource_names := {"//compute.googleapis.com/projects/prj-dev-palani-ram/zones/us-central1-f/instances/pals-jumphost"}
	expected_field_name := "key_in_violation"
	expected_field_values := {"serial-port-enable"}
